...
const essentialFiles = [
  ...
  path.join(WIN_WWWROOT, 'lib', 'bootstrap', 'bootstrap.bundle.min.js'),
  path.join(WIN_WWWROOT, 'lib', 'bootstrap-icons', 'bootstrap-icons.min.css'),
  path.join(WIN_WWWROOT, 'lib', 'katex', 'katex.min.css'),
